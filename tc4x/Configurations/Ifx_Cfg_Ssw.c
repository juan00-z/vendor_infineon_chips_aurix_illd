...
void Ifx_Ssw_Mbist(void)
{
    ...
    IfxVmt_clearStandbyram(IfxVmt_MbistSel_cpu0DlmuStby, IfxPmsPm_getStandbyRam0Size(&MODULE_PMS));
    IfxVmt_clearStandbyram(IfxVmt_MbistSel_cpu1DlmuStby, IfxPmsPm_getStandbyRam1Size(&MODULE_PMS));
}
